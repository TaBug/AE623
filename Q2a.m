...
writematrix(IE,"IE_test.txt")
% writematrix(IE,"IE_airf.txt")
writematrix(I2E,"I2E_test.txt")
% writematrix(I2E,"I2E_airf.txt")
writematrix(BE,"BE_test.txt")
% writematrix(BE,"BE_airf.txt")
writematrix(B2E,"B2E_test.txt")
% writematrix(B2E,"B2E_airf.txt")
